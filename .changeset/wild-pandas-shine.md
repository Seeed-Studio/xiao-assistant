...
First feature release since 0.0.3 — the package was audited end-to-end (two adversarial verification rounds, every finding reproduced and fixed) and now actually delivers what the README promises.
